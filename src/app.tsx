          ...
          <div class="text-center animate-fade-in">
            <Card variant="elevated" padding="lg" className="max-w-2xl mx-auto">
              ...
              <div class="flex flex-col sm:flex-row gap-3 mt-6 pt-6 border-t border-gray-200">
                <a
                  href="https://afif-fahim.notion.site/TriageAid-Offline-Medical-Triage-Assessment-Tool-2326e231ee9580959117d64a242032e9"
                  target="_blank"
                  rel="noopener noreferrer"
                  class="flex items-center justify-center gap-2 px-4 py-2 text-sm text-medical-text-secondary hover:text-medical-primary transition-colors duration-200 rounded-lg hover:bg-gray-50 flex-1"
                >
                ...
                <a
                  href="https://github.com/afif-fahim/triage-aid"
                  target="_blank"
                  rel="noopener noreferrer"
                  class="flex items-center justify-center gap-2 px-4 py-2 text-sm text-medical-text-secondary hover:text-medical-primary transition-colors duration-200 rounded-lg hover:bg-gray-50 flex-1"
                >
